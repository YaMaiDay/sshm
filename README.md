...
<p align="center">
  ...
  <a href="docs/troubleshooting.md">排错</a> ·
...
| 文档 | 说明 |
| --- | --- |
| [应用部署](docs/deployment.md) | Git / Release 部署、凭证、队列、回滚 |
| [排错](docs/troubleshooting.md) | SSH、跳板机、rsync、GitHub、磁盘、容器状态 |
| [安全策略](SECURITY.md) | 安全边界、敏感信息、本地数据 |
| [变更记录](CHANGELOG.md) | 当前版本主要变化 |
